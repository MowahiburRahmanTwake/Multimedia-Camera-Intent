package com.twakeapps.multimediacameraintent
...
import com.twakeapps.multimediacameraintent.databinding.ActivityMainBinding
import java.io.File
        ...
        startForResult = registerForActivityResult(
            ...
            if (result.resultCode == Activity.RESULT_OK){
                ...
                try
                {
                    ...
                    val rotateBitmap:Bitmap = Bitmap.createBitmap(mBitmap, 0,0, mBitmap.width,mBitmap.height,rotationMatrix,false)

                    binding.ivMain.setImageBitmap(mBitmap)
